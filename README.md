...
## Arduino
  - 기능
    ...
    3. 반대로 토양 수분의 수치가 일정 값보다 낮을 경우에는 수분이 충분하다는 것으로 판단되어 워터 펌프가 작동하지 않습니다.
...
## Raspberrypi
  - 기능
    ...
    2. 전송 받은 값이 설정값보다 높을 경우 워터 펌프가 작동되고, 이 경우에 텔레그램으로 "I'm Watering it now !" 라는 메시지를 사용자에게 전송합니다.
